...
$PHPTHUMB_CONFIG['high_security_password']   = 'ahdope989zs';     // required if 'high_security_enabled' is true, must be at least 5 characters long
...
$PHPTHUMB_CONFIG['disable_imagecopyresampled']      = true;  // if true, ImageCopyResampled is replaced with ImageCopyResampleBicubic. May be needed for buggy versions of PHP-GD.
